        ...
        <div class="crumbs">
            <el-form :inline="true" class="demo-form-inline" style="text-align:left">
                <el-form-item label="名称">
                    <el-input placeholder="名称" v-model="searchForm.otherName"></el-input>
                </el-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        tableConfigMsg: {
          tableTitle: [
            { name: 'otherName', label: '电子名称', align: 'center', width: '' },
    ...
    methods: {
      getData () {
        this.$store.dispatch('updateOthers')
      },
      // 分页
      ...
      handleEdit (index, row) {
        ...
        // 保存产品信息
        const aProductMsg = JSON.parse(JSON.stringify(this.dialogMsg.othersMsg))
      ...
      handleDelete (index, row) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          fetchDeleteOthers(data).then(res => {
            if (res.code === 100) {
